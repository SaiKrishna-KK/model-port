#!/usr/bin/env python3
# Script to fix the inference.py file
import os

# New content for inference.py with dtype handling
INFERENCE_CODE = """import onnxruntime as ort
import numpy as np
import json
import os
...
# Write the new inference.py to the modelport_capsule directory
with open('modelport_capsule/inference.py', 'w') as f:
    f.write(INFERENCE_CODE)

print("Fixed inference.py in modelport_capsule directory") 